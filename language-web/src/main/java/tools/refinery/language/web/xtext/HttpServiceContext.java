...
class HttpServiceContext implements IServiceContext {
	...
	public HttpServiceContext(HttpServletRequest request) throws IOException {
		this.request = request;
		initializeParameters();
	}

	private void initializeParameters() throws IOException {
		initializeUrlEncodedParameters();
		...
		if (!parameters.containsKey(IServiceContext.SERVICE_TYPE)) {
			...
			parameters.put(IServiceContext.SERVICE_TYPE, substring);
		}
	}

	private void initializeUrlEncodedParameters() throws IOException {
