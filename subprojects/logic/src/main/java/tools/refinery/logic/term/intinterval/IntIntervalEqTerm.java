...
public class IntIntervalEqTerm extends BinaryTerm<TruthValue, IntInterval, IntInterval> {
	public IntIntervalEqTerm(Term<IntInterval> left, Term<IntInterval> right) {
