...
public class AbstractDomainMaxAggregator<A extends ComparableAbstractValue<A, C>, C extends Comparable<C>>
		implements PartialAggregator<A, C, A, C> {
	private final ComparableAbstractDomain<A, C> abstractDomain;

	public AbstractDomainMaxAggregator(ComparableAbstractDomain<A, C> abstractDomain) {
