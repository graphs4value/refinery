...
public class AbstractDomainLessTerm<A extends ComparableAbstractValue<A, C>, C extends Comparable<C>>
	...
	public AbstractDomainLessTerm(ComparableAbstractDomain<A, C> abstractDomain, Term<A> left, Term<A> right) {
	...
	protected Term<TruthValue> constructWithSubTerms(Term<A> newLeft, Term<A> newRight) {
		return new AbstractDomainLessTerm<>((ComparableAbstractDomain<A, C>) getAbstractDomain(), newLeft, newRight);
	}
