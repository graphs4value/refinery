...
public class IntIntervalLessTerm extends BinaryTerm<TruthValue, IntInterval, IntInterval> {
	public IntIntervalLessTerm(Term<IntInterval> left, Term<IntInterval> right) {
