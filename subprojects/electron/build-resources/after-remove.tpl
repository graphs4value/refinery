...
# https://github.com/electron-userland/electron-builder/blob/ce825f1283950ca56e2ab345ec755599fa0d470e/packages/app-builder-lib/templates/linux/after-remove.tpl
# that removes the `refinery` symlink to our `ELECTRON_RUN_AS_NODE=1` entry point.
...
if type update-alternatives >/dev/null 2>&1; then
    update-alternatives --remove '${executable}' '/opt/${sanitizedProductName}/bin/refinery'
else
