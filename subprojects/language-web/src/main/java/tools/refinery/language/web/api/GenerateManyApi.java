...
import tools.refinery.language.web.api.dto.GenerateManyRequest;
...
public class GenerateManyApi {
	...
	public void generate(@Valid GenerateManyRequest request, @Suspended AsyncResponse asyncResponse) {
	...
	public void generate(@Valid GenerateManyRequest request, @Context SseEventSink eventSink, @Context Sse sse)
