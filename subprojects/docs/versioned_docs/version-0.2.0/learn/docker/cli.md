...
```shell
docker run --rm -it -v ${PWD}:/data ghcr.io/graphs4value/refinery-cli:0.2.0
```
...
```shell
docker run --rm -it -v ${PWD}:/data ghcr.io/graphs4value/refinery-cli:0.2.0 generate -o output.refinery input.problem
```

If you want Refinery CLI to print its documentation, run

```shell
docker run --rm -it -v ${PWD}:/data ghcr.io/graphs4value/refinery-cli:0.2.0 -help
```
...
```shell
docker run --rm -it -v ${PWD}:/data ghcr.io/graphs4value/refinery-cli:0.2.0 generate [options] input path
```
...
```shell
docker run --rm -it -v ${PWD}:/data ghcr.io/graphs4value/refinery-cli:0.2.0 generate -s File=20..25 input.problem
```
...
```shell
docker run --rm -it -v ${PWD}:/data ghcr.io/graphs4value/refinery-cli:0.2.0 check [options] input path
```
...
```shell
docker run --rm -it -v ${PWD}:/data ghcr.io/graphs4value/refinery-cli:0.2.0 concretize [options] input path
```
