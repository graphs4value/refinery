...
Refinery is written in Java and TypeScript. To build Refinery, you'll need a **Java 25** compatible **Java Development Kit (JDK).** We recommend the [Adoptium Java 25 JDK](https://adoptium.net/) or the [Amazon Corretto Java 25 JDK](https://aws.amazon.com/corretto/).
...
If you get any errors about the JVM version, check whether the `JAVA_HOME` environment variable is set to the location of **JDK 25**. You can query the variable with
