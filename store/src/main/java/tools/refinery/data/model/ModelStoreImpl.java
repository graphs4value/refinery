...
import tools.refinery.data.map.DiffCursor;
import tools.refinery.data.map.VersionedMap;
import tools.refinery.data.map.VersionedMapStore;
import tools.refinery.data.map.VersionedMapStoreImpl;
import tools.refinery.data.model.internal.ModelImpl;
import tools.refinery.data.model.internal.SimilarRelationEquivalenceClass;
import tools.refinery.data.model.representation.AuxilaryData;
